...
/*
 * Test will Place a message on the command pipe with an unrecognized message
 * ID.
 */
void SA_AppMain_Test_ECI_1001_1050(void)
{
    ...
    CFE_SB_InitMsg(&UT_CmdPacket, UNITTESTMODEL_CMD_MID + 5, sizeof(SA_NoArgsCmd_t), TRUE);

    CFE_SB_InitMsg(&UT_HkReqMsg, SA_SEND_HK_MID, sizeof(SA_NoArgsCmd_t), TRUE);

    /* Message with unrecognized Message ID placed on Command Pipe */
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_CmdPacket, CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_CmdPacket),
               0);
    ...
    /* Verifies that Error Event message sent and command accepted/error counters
     * updated */
...
void SA_AppMain_Test_ECI_1010(void)
{
    ...
    UtList_Add(&PipeTable[DATAPIPE].MsgQueue, &UT_outputPkt, CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_outputPkt),
               0);
    ...
    UtAssert_True(Ut_CFE_EVS_EventSent(ECI_UNK_MID_ERR_EID, CFE_EVS_ERROR,
                                       "Msg with Invalid MID Received on DATA PIPE: ID = 0x80A"),
                  "Error Event Message Outputted");

} /* End of SA_AppMain_Test_ECI_1010 */

/*
 * Test will Place messages with mismatched message lengths on the command &
 * data pipes.
 */
void SA_AppMain_Test_ECI_1020_1030_1050(void)
{
    ...
    CFE_SB_InitMsg(&UT_CmdPacket[0], UNITTESTMODEL_CMD_MID, sizeof(SA_NoArgsCmd_t) + 1, FALSE);
    CFE_SB_SetCmdCode((CFE_SB_MsgPtr_t)&UT_CmdPacket[0], 0);

    CFE_SB_InitMsg(&UT_CmdPacket[1], UNITTESTMODEL_CMD_MID, sizeof(SA_NoArgsCmd_t) + 1, FALSE);
    CFE_SB_SetCmdCode((CFE_SB_MsgPtr_t)&UT_CmdPacket[1], 1);

    CFE_SB_InitMsg(&UT_FDCConfigCmdPkt, UNITTESTMODEL_CMD_MID, sizeof(SA_FDCConfigCmd_t) + 1, FALSE);
    CFE_SB_SetCmdCode((CFE_SB_MsgPtr_t)&UT_FDCConfigCmdPkt, ECI_FAULTREP_CONFIG_CC);

    CFE_SB_InitMsg(&UT_FDCClearCmdPkt, UNITTESTMODEL_CMD_MID, sizeof(SA_FDCClearCmd_t) + 1, FALSE);
    CFE_SB_SetCmdCode((CFE_SB_MsgPtr_t)&UT_FDCClearCmdPkt, ECI_FAULTREP_CLEAR_CC);

    CFE_SB_InitMsg(&UT_InputPkt, INPUTCMDPKT_B_INPUTCMDPKT_S_MID, sizeof(inputCmdPkt_b) + 1, FALSE);

    CFE_SB_SetCmdCode((CFE_SB_MsgPtr_t)&UT_InputPkt, 102);

    CFE_SB_InitMsg(&UT_HK_Req_MsgErr, SA_SEND_HK_MID, sizeof(SA_NoArgsCmd_t) + 1, FALSE);

    CFE_SB_InitMsg(&UT_TickMsg, UNITTESTMODEL_TICK_MID, sizeof(SA_NoArgsCmd_t) + 1, FALSE);

    CFE_SB_InitMsg(&UT_TickMsgValid, UNITTESTMODEL_TICK_MID, sizeof(SA_NoArgsCmd_t), TRUE);

    CFE_SB_InitMsg(&UT_TblManageCmd, ECI_TBL_MANAGE_MID, sizeof(CFE_TBL_NotifyCmd_t) + 1, FALSE);

    CFE_SB_InitMsg(&UT_HK_Req_Msg, SA_SEND_HK_MID, sizeof(SA_NoArgsCmd_t), TRUE);

    CFE_SB_InitMsg(&UT_InputPkt1, INPUTTLMPKT1_B_INPUTTLMPKT1_S_MID, sizeof(inputTlmPkt1_b) + 1, FALSE);

    CFE_SB_InitMsg(&UT_InputPkt2, INPUTTLMPKT2_B_INPUTTLMPKT2_S_MID, sizeof(inputTlmPkt2_b) + 1, FALSE);

    /* Length Mismatched No-Op Command Message */
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_CmdPacket[0],
               CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_CmdPacket[0]) - 1, 0);

    /* Length Mismatched HK Reset Message */
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_CmdPacket[1],
               CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_CmdPacket[1]) - 1, 0);

    /* Length Mismatched Config FDC Command Message */
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_FDCConfigCmdPkt,
               CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_FDCConfigCmdPkt) - 1, 0);

    /* Length Mismatched Clear FDC Command Message */
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_FDCClearCmdPkt,
               CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_FDCClearCmdPkt) - 1, 0);

    /* Length Mismatched Auto-coded Command Message */
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_InputPkt, CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_InputPkt) - 1,
               0);

    /* Length Mismatched Table Management Message */
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_TblManageCmd,
               CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_TblManageCmd) - 1, 0);

    /* Length Mismatched Wakeup Message */
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_TickMsg, CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_TickMsg) - 1,
               0);

    /* Length Mismatched HK Request Message */
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_HK_Req_MsgErr,
               CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_HK_Req_MsgErr) - 1, 0);

    /* Length Mismatched Data Message (1 of 2) */
    UtList_Add(&PipeTable[DATAPIPE].MsgQueue, &UT_InputPkt1,
               CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_InputPkt1) - 1, 0);

    /* Length Mismatched Data Message (2 of 2) */
    UtList_Add(&PipeTable[DATAPIPE].MsgQueue, &UT_InputPkt2,
               CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_InputPkt2) - 1, 0);

    /* Valid Wakeup Message */
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_TickMsgValid,
               CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_TickMsgValid), 0);

    /* Valid HK Request Message */
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_HK_Req_Msg, CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_HK_Req_Msg),
               0);
    ...
    UtAssert_True(Ut_CFE_EVS_GetEventCount(ECI_CMD_LEN_ERR_EID, CFE_EVS_ERROR, "Invalid cmd pkt: ID = ") == 8,
                  "Command Event Error Counter Incremented");
    UtAssert_True(Ut_CFE_EVS_GetEventCount(ECI_TLM_LEN_ERR_EID, CFE_EVS_ERROR, "Invalid tlm pkt: ID = ") == 2,
                  "Telemetry Event Error Counter Incremented");
...
void SA_AppMain_Test_INIT_1001_TBL_1002(void)
{
    ...
    CFE_SB_InitMsg(&UT_InputPkt, UNITTESTMODEL_CMD_MID, sizeof(inputCmdPkt_b), TRUE);
    CFE_SB_SetCmdCode((CFE_SB_MsgPtr_t)&UT_InputPkt, 102);

    UT_InputPkt.arg1 = 1;

    CFE_SB_InitMsg(&UT_TickMsg, UNITTESTMODEL_TICK_MID, sizeof(SA_NoArgsCmd_t), TRUE);
    ...
    UtAssert_True(Ut_CFE_EVS_GetEventCount(ECI_INIT_INF_EID, CFE_EVS_INFORMATION, "") == 1,
                  "ECI_INIT_INF_EID Event Counter Incremented");
...
void SA_AppMain_Test_TBL_1010(void)
{
    ...
    CFE_SB_InitMsg(&UT_TblManageCmd_0, ECI_TBL_MANAGE_MID, sizeof(CFE_TBL_NotifyCmd_t), TRUE);

    UT_TblManageCmd_0.Payload.Parameter = 0;

    CFE_SB_InitMsg(&UT_TblManageCmd_1, ECI_TBL_MANAGE_MID, sizeof(CFE_TBL_NotifyCmd_t), TRUE);

    UT_TblManageCmd_1.Payload.Parameter = 1;

    CFE_SB_InitMsg(&UT_TblManageCmd_2, ECI_TBL_MANAGE_MID, sizeof(CFE_TBL_NotifyCmd_t), TRUE);

    UT_TblManageCmd_2.Payload.Parameter = 0;

    CFE_SB_InitMsg(&UT_TblManageCmd_3, ECI_TBL_MANAGE_MID, sizeof(CFE_TBL_NotifyCmd_t), TRUE);
    ...
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_TblManageCmd_0,
               CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_TblManageCmd_0), 0);
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_TblManageCmd_1,
               CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_TblManageCmd_1), 0);
    /* Place auto-generated command to output active tbl contents in telemetry */
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_InputPkt, CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_InputPkt), 0);
    /* Place Wakeup message onto command message */
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_TickMsg, CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_TickMsg), 0);

    /* Using CFE_TBL_Manage() stub which indicates table update is pending - Place
     * Valid Table management messages on command message */
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_TblManageCmd_2,
               CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_TblManageCmd_2), 0);
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_TblManageCmd_3,
               CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_TblManageCmd_3), 0);
    /* Place auto-generated command to output active tbl contents in telemetry */
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_InputPkt, CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_InputPkt), 0);
    /* Place Wakeup message onto command message */
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_TickMsg, CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_TickMsg), 0);
...
void SA_AppMain_Test_ECI_1040_CMD_1001_SB_1001_NoOpCmd(void)
{
    ...
    CFE_SB_InitMsg(&UT_CmdPacket, UNITTESTMODEL_CMD_MID, sizeof(SA_NoArgsCmd_t), TRUE);
    ...
    /* Verify that Command Counter Increments and Informational Event Message
     * Outputted */
    ...
    UtAssert_True(Ut_CFE_EVS_GetEventCount(ECI_NOOP_INF_EID, CFE_EVS_INFORMATION, "No-op command") == 1,
                  "Informational No-Op Event Message Sent");
...
void SA_AppMain_Test_SB_1001_CMD_1010_ResetHkCtrsCmd(void)
{
    ...
    CFE_SB_InitMsg(&UT_NoOpPacket, UNITTESTMODEL_CMD_MID, sizeof(SA_NoArgsCmd_t), TRUE);
    CFE_SB_SetCmdCode((CFE_SB_MsgPtr_t)&UT_NoOpPacket, ECI_NOOP_CC);

    CFE_SB_InitMsg(&UT_NoOpPacketErr, UNITTESTMODEL_CMD_MID, sizeof(SA_NoArgsCmd_t) + 1, FALSE);
    CFE_SB_SetCmdCode((CFE_SB_MsgPtr_t)&UT_NoOpPacketErr, ECI_NOOP_CC);

    CFE_SB_InitMsg(&UT_inputCmdPkt, INPUTCMDPKT_B_INPUTCMDPKT_S_MID, sizeof(inputCmdPkt_b), FALSE);

    CFE_SB_SetCmdCode((CFE_SB_MsgPtr_t)&UT_inputCmdPkt, 102);

    CFE_SB_InitMsg(&UT_inputTlmPkt1, INPUTTLMPKT1_B_INPUTTLMPKT1_S_MID, sizeof(inputTlmPkt1_b), TRUE);

    CFE_SB_InitMsg(&UT_inputTlmPkt2, INPUTTLMPKT2_B_INPUTTLMPKT2_S_MID, sizeof(inputTlmPkt2_b), TRUE);
    ...
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_NoOpPacket, CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_NoOpPacket),
               0);
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_NoOpPacket, CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_NoOpPacket),
               0);
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_NoOpPacket, CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_NoOpPacket),
    ...
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_NoOpPacketErr,
               CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_NoOpPacket), 0);
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_NoOpPacketErr,
               CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_NoOpPacket), 0);
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_NoOpPacketErr,
               CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_NoOpPacket), 0);
    ...
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_inputCmdPkt,
               CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_inputCmdPkt), 0);
    UtList_Add(&PipeTable[DATAPIPE].MsgQueue, &UT_inputTlmPkt1,
               CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_inputTlmPkt1), 0);
    UtList_Add(&PipeTable[DATAPIPE].MsgQueue, &UT_inputTlmPkt2,
               CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_inputTlmPkt2), 0);
    ...
    UtAssert_True(
        Ut_CFE_EVS_GetEventCount(ECI_RESET_HK_CTR_INF_EID, CFE_EVS_INFORMATION, "Reset Housekeeping Counters") == 1,
        "Information Event For HK Counter Reset Sent");

    /* Check that HK Telmetry Received */
    UtAssert_True(Ut_CFE_SB_GetMsgCount(UNITTESTMODEL_HK_MID) == 2,
                  "HK Telemetry Packets Received because of two HK request Messages");

} /* End of SA_AppMain_Test_SB_1001_CMD_1010_ResetHkCtrsCmd */

/*
 * Enough autogenerated commands will be received so that command queue will
 * overflow
 */
void SA_AppMain_Test_CMD_1050_1051_1052_1053(void)
{
    ...
    CFE_SB_InitMsg(&UT_InputPkt2, UNITTESTMODEL_CMD_MID, sizeof(inputCmdPkt_b), TRUE);
    ...
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_InputPkt, CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_InputPkt), 0);
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_InputPkt, CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_InputPkt), 0);
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_InputPkt2, CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_InputPkt2),
               0);
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_InputPkt2, CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_InputPkt2),
               0);
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_InputPkt2, CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_InputPkt2),
    ...
    /* Verify that Command & Error Counter Incremented Correctly, Commands
     * Executed, and Error Event Messages sent */

    UtAssert_True(HkPacket->CmdErrorCounter == 3, "Command Rejected Counter Incremented Correctly for Command "
                                                  "Messages that overflow Msg Queue");
    UtAssert_True(HkPacket->CmdAcceptCounter == 25, "Command Accepted Counter Incremented Correctly for Command "
                                                    "Messages that are Queued");

    UtAssert_True(Ut_CFE_SB_GetMsgCount(OUTPUTTLMPKT3_B_OUTPUTTLMPKT3_S_MID) == 25,
                  "SIL-Defined Command Executed 1 of 2");
    UtAssert_True(Ut_CFE_SB_GetMsgCount(OUTPUTTLMPKT4_B_OUTPUTTLMPKT4_S_MID) == 25,
                  "SIL-Defined Command Executed 2 of 2");

    UtAssert_True(Ut_CFE_EVS_GetEventCount(ECI_QFULL_ERR_EID, CFE_EVS_ERROR,
                                           "Cmd Queue for mid 0x1802 is full. Msg dropped") == 3,
                  "Queue Full Error Event Counter Incremented Correctly");

} /* End of SA_AppMain_Test_CMD_1050_1051_1052_1053 */

/*
 * Autogenerated commands with function codes outside the range of valid values
 * will be placed on Command Pipe
 */
void SA_AppMain_Test_CMD_1060(void)
{
    ...
    CFE_SB_InitMsg(&UT_InputPkt1, UNITTESTMODEL_CMD_MID, sizeof(inputCmdPkt_b), TRUE);
    ...
    /* Autogenerated command message with function codes outside valid range of
     * 100-110 placed on command pipe */
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_InputPkt1, CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_InputPkt1),
               0);
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_InputPkt2, CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_InputPkt2),
               0);
    ...
    /* Verify that command error counter incremented, commands not executed and
     * Error Event Message outputted */
    ...
    UtAssert_True(Ut_CFE_SB_GetMsgCount(OUTPUTTLMPKT3_B_OUTPUTTLMPKT3_S_MID) == 0,
                  "SIL-Defined Command Correctly NOT Executed 1 of 2");
    UtAssert_True(Ut_CFE_SB_GetMsgCount(OUTPUTTLMPKT4_B_OUTPUTTLMPKT4_S_MID) == 0,
                  "SIL-Defined Command Correctly NOT Executed 2 of 2");

    UtAssert_True(Ut_CFE_EVS_GetEventCount(ECI_INV_CMD_CODE_ERR_EID, CFE_EVS_ERROR,
                                           "Invalid Command Code: ID = 0x1802, CC = ") == 2,
                  "Function Code Error Event Counter Incremented Correctly");
...
void SA_AppMain_Test_TIME_1001(void)
{
    ...
    CFE_SB_InitMsg(&UT_Tick, UNITTESTMODEL_TICK_MID, sizeof(SA_NoArgsCmd_t), TRUE);
    ...
    UtAssert_True(Ut_CFE_EVS_GetEventCount(15, CFE_EVS_DEBUG, "Loc: unitTestModel/event1, Time is 1000.500000") == 1,
                  "SIL Time Event Counter Incremented");
...
void SA_AppMain_Test_FDC_1001_1030(void)
{
    ...
    CFE_SB_InitMsg(&inputTlm2[0], INPUTTLMPKT2_B_INPUTTLMPKT2_S_MID, sizeof(inputTlmPkt2_b), TRUE);

    inputTlm2[0].inVal1 = 10;
    inputTlm2[0].inVal2 = 8;

    /* Set conditions in Input Data Telemetry to UNSET FDC */
    CFE_SB_InitMsg(&inputTlm2[1], INPUTTLMPKT2_B_INPUTTLMPKT2_S_MID, sizeof(inputTlmPkt2_b), TRUE);
    ...
    CFE_SB_InitMsg(&FDCConfigCmd[0], UNITTESTMODEL_CMD_MID, sizeof(SA_FDCConfigCmd_t), TRUE);

    /* Invalid FDC Config Command with invalid FDC ID */
    CFE_SB_InitMsg(&FDCConfigCmd[1], UNITTESTMODEL_CMD_MID, sizeof(SA_FDCConfigCmd_t), TRUE);

    /* Invalid FDC Config Command with invalid FDC Config State */
    CFE_SB_InitMsg(&FDCConfigCmd[2], UNITTESTMODEL_CMD_MID, sizeof(SA_FDCConfigCmd_t), TRUE);

    /* Invalid FDC Config Command with invalid FDC Config State */
    CFE_SB_InitMsg(&FDCConfigCmd[3], UNITTESTMODEL_CMD_MID, sizeof(SA_FDCConfigCmd_t), TRUE);

    /* Valid FDC Clear Command*/
    CFE_SB_InitMsg(&FDCClearCmd[0], UNITTESTMODEL_CMD_MID, sizeof(SA_FDCClearCmd_t), TRUE);

    /* Invalid FDC Clear Command with invalid FDC ID */
    CFE_SB_InitMsg(&FDCClearCmd[1], UNITTESTMODEL_CMD_MID, sizeof(SA_FDCClearCmd_t), TRUE);
    ...
    CFE_SB_InitMsg(&UT_HKRequest, SA_SEND_HK_MID, sizeof(SA_NoArgsCmd_t), TRUE);

    /* Place Valid FDC Config Message enabling FDC ID 0 */
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &FDCConfigCmd[0],
               CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&FDCConfigCmd[0]), 0);

    /* Place Invalid FDC Config Message enabling FDC ID 2 */
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &FDCConfigCmd[1],
               CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&FDCConfigCmd[1]), 0);

    /* Place Invalid FDC Config Message enabling FDC ID 0 with value 2 */
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &FDCConfigCmd[2],
               CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&FDCConfigCmd[2]), 0);

    /* Place Wakeup message onto Command Pipe */
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_Tick, CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_Tick), 0);

    /* Place HK Request Message onto command pipe */
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_HKRequest, CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_HKRequest),
               0);

    /* Place valid FDC Clear message clearing FDC ID 0 */
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &FDCClearCmd[0],
               CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&FDCClearCmd[0]), 0);

    /* Place invalid FDC Clear message clearing FDC ID 2 */
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &FDCClearCmd[1],
               CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&FDCClearCmd[1]), 0);
    ...
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &FDCConfigCmd[3],
               CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&FDCConfigCmd[3]), 0);
    ...
    UtList_Add(&PipeTable[DATAPIPE].MsgQueue, &inputTlm2[0], CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&inputTlm2[0]),
               0);

    /* Place data message onto data pipe which will unset FDC */
    UtList_Add(&PipeTable[DATAPIPE].MsgQueue, &inputTlm2[1], CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&inputTlm2[1]),
               0);
    ...
    UtAssert_True(HkPacket->CmdErrorCounter == 2, "Command Rejected Counter Incremented for two invalid FDC "
                                                  "Config Command");
    ...
    UtAssert_True(HkPacket->Latched[0] == 1, "FDC Latched State Set due to FDC Condition Met via input "
                                             "telemetry message");
    ...
    /* Verify that FDC Config Commands to disable is being validated and executed
     * correctly */
    ...
    UtAssert_True(HkPacket->Latched[0] == 0, "FDC Latched State cleared due to FDC condition not being met via input "
                                             "telemetry message and the previous FDC clear command");
    UtAssert_True(FdcPacket->Tlm.Data[0] == 0, "FDC Tlm Set due to FDC Condition not being met via input "
                                               "telemetry message");

    UtAssert_True(Ut_CFE_EVS_GetEventCount(APP_FAULTREP_EVS_INV_DETECTOR_ID, CFE_EVS_ERROR,
                                           "Fault Reporter Reject Config Detector Cmd: "
                                           "Invalid fault ID 2 (Max ID = 0)") == 1,
                  "Error event received due to FDC Config command with invalid FDC IDs");
    UtAssert_True(Ut_CFE_EVS_GetEventCount(APP_FAULTREP_EVS_INV_DETECTOR_ID, CFE_EVS_ERROR,
                                           "Fault Reporter Rejected Clear Detector Cmd:  "
                                           "Invalid fault ID 2 (Max ID = 0)") == 1,
                  "Error event received due to FDC Clear command with invalid FDC IDs");
    UtAssert_True(Ut_CFE_EVS_GetEventCount(APP_FAULTREP_EVS_CONFIG_CMD_ERR, CFE_EVS_ERROR,
                                           "Fault Reporter Reject Config Detector Cmd: "
                                           "Invalid enable value 2") == 1,
                  "Error event received due to FDC Config commands with invalid FDC Enable "
                  "State");
...
void SA_AppMain_Test_INIT_1012(void)
{
    ...
    UtAssert_True(Ut_CFE_EVS_GetEventCount(ECI_PARAM_TBL_LOAD_ERR_EID, CFE_EVS_ERROR, "") == 3,
                  "ECI_PARAM_TBL_LOAD_ERR_EID Event Counter Incremented");

    /* Check for Event Indicating that Initialization Failed */
    UtAssert_True(Ut_CFE_EVS_GetEventCount(ECI_INIT_FAIL_ERR_EID, CFE_EVS_ERROR, "") == 3,
                  "ECI_INIT_FAIL_ERR_EID Event Counter Incremented");
...
void SA_AppMain_Test_Wakeup(void)
{
    ...
    /* Create inputTlmPkt2_b which will set the outputTlmPkt2 data telemetry
     * Output */
    CFE_SB_InitMsg(&UT_InputTlmPkt2_1, INPUTTLMPKT2_B_INPUTTLMPKT2_S_MID, sizeof(inputTlmPkt2_b), TRUE);

    UT_InputTlmPkt2_1.inVal3 = 12;

    /* Create inputTlmPkt2_b which will set the outputTlmPkt2 data telemetry to
     * NOT Output */
    CFE_SB_InitMsg(&UT_InputTlmPkt2_2, INPUTTLMPKT2_B_INPUTTLMPKT2_S_MID, sizeof(inputTlmPkt2_b), TRUE);
    ...
    UtList_Add(&PipeTable[DATAPIPE].MsgQueue, &UT_InputTlmPkt2_1,
               CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_InputTlmPkt2_1), 0);
    UtList_Add(&PipeTable[DATAPIPE].MsgQueue, &UT_InputTlmPkt2_2,
               CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_InputTlmPkt2_1), 0);
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_Tick, CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_Tick), 0);
    UtList_Add(&PipeTable[CMDPIPE].MsgQueue, &UT_HK_Req_Msg, CFE_SB_GetTotalMsgLength((CFE_SB_MsgPtr_t)&UT_HK_Req_Msg),
               0);
    ...
    UtAssert_True(Ut_CFE_SB_GetMsgCount(OUTPUTTLMPKT1_B_OUTPUTTLMPKT1_S_MID) == 2,
                  "SIL Wakeup Results in correct output Telemetry placed on SB 1 of 1");
    UtAssert_True(Ut_CFE_SB_GetMsgCount(OUTPUTTLMPKT2_B_OUTPUTTLMPKT2_S_MID) == 1,
                  "SIL Wakeup Results in correct output Telemetry placed on SB 2 of 2");

    UtAssert_True(Ut_CFE_SB_GetMsgCount(UNITTESTMODEL_FDC_MID) == 2,
                  "SIL Outputs 2 FDC Packets because of 2 received Wake-up signals");
