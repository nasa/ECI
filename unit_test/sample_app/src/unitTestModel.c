...
void unitTestModel_step(void)
{
     ...
     */
    rtb_SeqCnt = (uint16_T)((inputCmdPkt_s.CmdHdr.Sequence[1] << 8 | inputCmdPkt_s.CmdHdr.Sequence[0]) & 16383);
     ...
     */
    tmp = floor(rt_modd_snf(
        floor(((real_T)ECI_Step_TimeStamp.Seconds + ((real_T)ECI_Step_TimeStamp.Subseconds / 4294967296.0))), 255.0));
     ...
     */
    unitTestModel_B.BusCreator.outVal2 =
        (uint8_T)(tmp < 0.0 ? (int32_T)(uint8_T) - (int8_T)(uint8_T)-tmp : (int32_T)(uint8_T)tmp);
     ...
     */
    unitTestModel_B.RelationalOperator = (inputTlmPkt2_s.inVal3 > (*param_TBL2).param3);
     ...
     *  Inport: '<Root>/inputTlmPkt2'
     */
    unitTestModel_B.RelationalOperator1 = (inputTlmPkt2_s.inVal1 > inputTlmPkt2_s.inVal2);
    ...
    unitTestModel_B.CFS_GNC_Time =
        ((real_T)ECI_Step_TimeStamp.Seconds + ((real_T)ECI_Step_TimeStamp.Subseconds / 4294967296.0));
...
void unitTestModel_initialize(void)
{
    ...
    /* block I/O */
    (void)memset(((void *)&unitTestModel_B), 0, sizeof(B_unitTestModel_T));
    ...
    /* states (dwork) */
    (void)memset((void *)&unitTestModel_DW, 0, sizeof(DW_unitTestModel_T));

    /* exported global states */
    (void)memset(&evData_unitTestModel_122, 0, 5U * sizeof(real_T));
    (void)memset(&evData_unitTestModel_154, 0, 5U * sizeof(real_T));
    (void)memset(&evData_unitTestModel_155, 0, 5U * sizeof(real_T));
    (void)memset(&evData_unitTestModel_152, 0, 5U * sizeof(real_T));
