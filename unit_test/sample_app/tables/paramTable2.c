...
paramTable2_b UT_param_TBL2 = {6U, 7U, 8U, 9U, 10U};
 ...
 */
ECI_TBL_FILEDEF(CFE_TBL_FileDef, UT_param_TBL2, unitTestModel.param_TBL2, unitTestModel param_TBL2, paramTable2.tbl)
/*
