...
FRAME_DIR_LIST = { "./doxyrest/frame/cfamily/", "./doxyrest/frame/common" }
...
FRAME_FILE = "./doxyrest/frame/cfamily/index.rst.in"
...
OUTPUT_FILE = "./source/rst/index.rst"
...
INDEX_TITLE = "ECI (External Code Interface)"
