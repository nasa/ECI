...
#
TABLES = checkParams.tbl convParam.tbl
...
INCLUDE_PATH += -I$(CFE_CORE_SRC)/inc 
INCLUDE_PATH += -I$(CFE_PSP_SRC)/inc 
INCLUDE_PATH += -I$(CFE_PSP_SRC)/$(PSP)/inc 
INCLUDE_PATH += -I$(CFS_APP_SRC)/inc 
INCLUDE_PATH += -I$(CFS_APP_SRC)/$(PARENTAPP)/fsw/src 
INCLUDE_PATH += -I$(CFS_APP_SRC)/$(PARENTAPP)/fsw/eci_inc 
INCLUDE_PATH += -I$(CFS_APP_SRC)/eci/fsw/src 
INCLUDE_PATH += -I$(CFS_APP_SRC)/eci/fsw/faultrep 
INCLUDE_PATH += -I$(CFS_MISSION_INC) 
INCLUDE_PATH += -I../cfe/inc 
INCLUDE_PATH += -I../inc
##
