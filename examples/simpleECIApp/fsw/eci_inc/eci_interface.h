...
static ECI_Tbl_t ECI_ParamTable[] = {
    ...
    {
        &(checkParamsPtr), "checkParams", "SA app's check parameter table", "checkParams.tbl",
        sizeof(checkParamStruct_t), NULL /** NULL if table validation function isn't used */
    },
...
static ECI_Msg_t ECI_MsgRcv[] = {
    ...
    {0x0AA6, &inputData, sizeof(inputStruct_t), NULL, /** Null for telemetry packets */
     NULL},                                           /** Unused for input packets */
