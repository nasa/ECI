 ...
 *  at the end of the parameter table header file to be later compiled with
 * elf2cfetbl. This macro uses expansion to resolve it's names so there should
 * be no commented strings as parameters.
 *
 * @param StructName Data structure type to be used as the table image
 * format<br/>
 * @param ObjName Name of the object to be placed in the parameter table<br/>
 * @param TblName Name of the table registered with
 * :c:type:`ECI_Tbl_t.tblname`<br/>
 * @param Desc Quick description of the table<br/>
 * @param Filename What to name the file<br/>
 * @returns Static declaration of CFE_TBL_FileDef_t to be used with
 * elf2cfetbl<br/>
 */
