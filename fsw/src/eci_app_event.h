 ...
 */
/**
 * :Description: ECI initializes successfully event<br/><br/>
 * :Text: "Application Initialized, Revision %s", REVISION_NUMBER<br/><br/>
 * :Type: Informational<br/><br/>
 * :Cause: Application initializes<br/><br/>
 */
