...
sed -i '6a CFE_APP, /cf/op.so,          op_AppMain,     OP_APP,       90,   8192, 0x0, 0;' ./sample_defs/cpu1_cfe_es_startup.scr
...
# update makefile to include math library(check and make sure this file still exists)
