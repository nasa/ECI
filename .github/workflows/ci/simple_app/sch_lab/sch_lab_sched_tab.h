...
SCH_LAB_ScheduleTable_t SCH_LAB_ScheduleTable[SCH_LAB_MAX_SCHEDULE_ENTRIES] = {
    ...
    {CFE_EVS_SEND_HK_MID, 4, 0}, {CFE_TIME_SEND_HK_MID, 4, 0}, {CFE_SB_SEND_HK_MID, 4, 0},  {CFE_TBL_SEND_HK_MID, 4, 0},

    {CI_LAB_SEND_HK_MID, 4, 0},  {TO_LAB_SEND_HK_MID, 4, 0},   {SIMPLE_ECI_TICK_MID, 4, 0},
